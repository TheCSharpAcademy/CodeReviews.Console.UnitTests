...
public static class UserInput
{
    ...
    {
        var input = AnsiConsole.Prompt(new TextPrompt<string>("Enter the date in dd-MM-yyyy HH:mm format")
            .Validate(d =>
    ...
    public static CodingSession GetUserRecordInput()
    {
        ...
        var duration = CalculateDateDifference(startDate, endDate);

        var newRecord = new CodingSession
        {
            StartDate = startDate,
            EndDate = endDate,
            Duration = duration
