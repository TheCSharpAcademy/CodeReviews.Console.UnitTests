...
namespace CodingTracker
{
    public class CodingController
    {
        ...
        public static void Insert()
        {
            ...
            if (!Validation.ValidateDuration(startTime, endTime, "dd/MM/yyyy HH:mm"))
            {
                Insert();
            }
            ...
            while (true)
            {
                ...
                if (Console.KeyAvailable && Console.ReadKey(true).Key == ConsoleKey.Escape)
                {
                    ...
                    using (var connection = new SqliteConnection(connectionString))
                    {
                        ...
                        if (Goals.First() != null)
                        {
                            Goals.First().ProgressRemaining = Goals.First().ProgressRemaining - stopwatchElapsed;
                        }
        ...
        public static void Update()
        {
            ...
            using (var connection = new SqliteConnection(connectionString))
            {
                ...
                tableCmd.CommandText = $"UPDATE coding_sessions SET StartTime = '{newStartTime}', EndTime = '{newEndTime}', Duration = '' WHERE Id = {recordId}";
