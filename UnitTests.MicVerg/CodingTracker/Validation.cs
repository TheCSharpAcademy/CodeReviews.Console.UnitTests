namespace CodingTracker
{
    ...
    {
        public static DateTime ParseAndValidateDate(string message)
        {
        ...
        {
            if (string.IsNullOrEmpty(dateInput) || !DateTime.TryParseExact(dateInput, "d/M/yyyy H:mm", null, System.Globalization.DateTimeStyles.None, out _))
            {
                return false;
            }
            else
